...
def argparser():
    ...
    parser.add_argument('--alg', help='chose algorithm one of gail, ppo, bc, kl_bc', default='bc')
    parser.add_argument('--model', help='number of model to test. model.ckpt-number', default='200')
